...
const monday = ['2020-6-8', '10:00', '13:00', 1.5]
const tuesday = ['2020-6-9', '11:00', '19:00', 1.5]
const wednesday = ['2020-6-10', '22:00', '23:00', 0.5]
const thursday = ['2020-6-11', '13:00', '22:00', 1.5]
const friday = ['2020-6-12', '10:00', '22:00', 1.5]
const saturday = ['2020-6-13', '13:00', '23:00', 0.5]
...
function calculate(){
    ...
    var startTime4 = day[3][1][0]*10 + day[3][1][1]*1
    var endTime4 = day[3][2][0]*10 + day[3][2][1]*1
    var rate4 = (endTime4 - startTime4)* 60 * 1.5;
    console.log(`Rate for 2020-6-11 is RM ${rate4}`);

    var startTime5 = day[4][1][0]*10 + day[4][1][1]*1
    var endTime5 = day[4][2][0]*10 + day[4][2][1]*1
    var rate5 = (endTime5 - startTime5)* 60 * 1.5;
    console.log(`Rate for 2020-6-12 is RM ${rate5}`);

    var startTime6 = day[5][1][0]*10 + day[5][1][1]*1
    var endTime6 = day[5][2][0]*10 + day[5][2][1]*1
    var rate6 = (endTime6 - startTime6)* 60 * 0.5;
    console.log(`Rate for 2020-6-13 is RM ${rate6}`);

    var startTime7 = day[6][1][0]*10 + day[6][1][1]*1
    var endTime7 = day[6][2][0]*10 + day[6][2][1]*1
    var rate7 = (endTime7 - startTime7)* 60 * 0.5;
